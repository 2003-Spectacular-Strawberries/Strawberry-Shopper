...
This is your online shopping website for all your strawberry needs!!

## Setup

To use/edit Strawberry Shopper, you'll need to take the following steps:

* Fork or clone this repo
* npm install
* create the database by running:
  createdb strawberry-shopper
* npm run seed
